...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-B_nXhyaq.js';
...
const lang_map = {
  python: () => import('./index29-6yvYoGQu.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-DA2sAE3s.js'),
      import('./frontmatter-BdYbint0.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-CH3fY0Br.js').then((m) => m.json()),
  html: () => import('./index31-ZDMDC8IQ.js').then((m) => m.html()),
  css: () => import('./index32-yreccwTf.js').then((m) => m.css()),
  javascript: () => import('./index33-DgRhpk4c.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-DgRhpk4c.js').then(
...
//# sourceMappingURL=Index13-BeT_hRZt.js.map
